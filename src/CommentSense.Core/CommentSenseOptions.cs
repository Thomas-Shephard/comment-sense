...
)
{
    ...
    public static CommentSenseOptions FromAnalyzerConfigOptions(AnalyzerConfigOptions options, AnalyzerConfigOptions globalOptions)
    {
    ...
    public static bool HasOption(AnalyzerConfigOptions options, AnalyzerConfigOptions globalOptions, string name)
    {
        var key = Prefix + name;
        return options.TryGetValue(key, out _) || globalOptions.TryGetValue(key, out _);
    }

    public static T GetEnumOption<T>(AnalyzerConfigOptions options, AnalyzerConfigOptions globalOptions, string name, T defaultValue) where T : struct, Enum
    {
        var key = Prefix + name;
    ...
    public static bool GetBoolOption(AnalyzerConfigOptions options, AnalyzerConfigOptions globalOptions, string name, bool defaultValue = false)
    {
        var key = Prefix + name;
    ...
    public static int GetIntOption(AnalyzerConfigOptions options, AnalyzerConfigOptions globalOptions, string name, int defaultValue)
    {
        var key = Prefix + name;
    ...
    public static double GetDoubleOption(AnalyzerConfigOptions options, AnalyzerConfigOptions globalOptions, string name, double defaultValue)
    {
        var key = Prefix + name;
    ...
    public static IImmutableSet<string> GetSetOption(AnalyzerConfigOptions options, AnalyzerConfigOptions globalOptions, string name, IImmutableSet<string> defaultValue)
    {
        var key = Prefix + name;
    ...
    public static ImmutableHashSet<string> ParseSet(string value)
    {
        return value.Split(',')
            .Select(t => t.Trim())
