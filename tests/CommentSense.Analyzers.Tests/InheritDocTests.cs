...
public class InheritDocTests : CommentSenseAnalyzerTestBase<CommentSenseAnalyzer>
{
    ...
    [Test]
    public async Task InheritDocOnUsingDirectiveDoesNotReportDiagnostic()
    {
        const string testCode = """
            /// <inheritdoc/>
            using System;
    ...
    [Test]
    public async Task InheritDocOnAssemblyAttributeDoesNotReportDiagnostic()
    {
        const string testCode = """
            /// <inheritdoc/>
    ...
    [Test]
    public async Task InheritDocAsFullElementWithDocsDoesNotReportDiagnostic()
    {
        const string testCode = """
            public class Base
            {
            ...
            public class Derived : Base
            {
                /// <inheritdoc cref="Base.M">Inherited from Base</inheritdoc>
                public override void M() { }
            }
            """;
        await VerifyCSenseAsync(testCode, expectDiagnostic: false, diagnosticOptions: [("CSENSE001", ReportDiagnostic.Suppress)]);
    ...
    [Test]
    public async Task InheritDocWithCrefToPrivateMemberDoesNotReportDiagnostic()
    {
        const string testCode = """
            public class Other
            {
                /// <summary>Private documentation.</summary>
                private void PrivateMethod() { }
            }

            public class MyClass
            {
                /// <inheritdoc cref="Other.PrivateMethod"/>
                public void M() { }
            }
            """;
        await VerifyCSenseAsync(testCode, expectDiagnostic: false, diagnosticOptions: [("CSENSE001", ReportDiagnostic.Suppress), ("CSENSE025", ReportDiagnostic.Suppress)]);
    }

    [Test]
    public async Task InheritDocOnMemberWithMalformedDocumentationReportsDiagnostic()
    {
        const string testCode = """
            public class Base
            {
    ...
    [Test]
    public async Task InheritDocOnMemberWithUnbalancedTagsReportsDiagnostic()
    {
        // Malformed XML in metadata or generated by Roslyn can trigger TryParseDocumentation failure.
        const string testCode = """
            public class Base
            {
                /// <summary><b></summary>
    ...
    [Test]
    public async Task InheritDocInStrayCommentDoesNotReportDiagnostic()
    {
        const string testCode = """
            public class MyClass { }
    ...
    [Test]
    public async Task InheritDocWithSignatureMismatchCrefDoesNotReportDiagnostic()
    {
        const string testCode = """
            public class Base
            {
                /// <summary>Base doc.</summary>
                public void Target(int x) { }
            }

            public class MyClass
            {
                /// {|CSENSE026:<inheritdoc cref="Base.Target(string)"/>|}
                public void M() { }
            }
            """;
        await VerifyCSenseAsync(testCode, diagnosticOptions: [("CSENSE001", ReportDiagnostic.Suppress), ("CSENSE002", ReportDiagnostic.Suppress), ("CSENSE007", ReportDiagnostic.Suppress), ("CSENSE025", ReportDiagnostic.Suppress)]);
    }

    [Test]
    public async Task InheritDocWithAmbiguousCrefReportsDiagnostic()
    {
        const string testCode = """
            public class TargetClass
            {
                /// <summary>Overload 1.</summary>
                public void Target(int x) { }
                /// <summary>Overload 2.</summary>
                public void Target(string x) { }
            }

            public class MyClass
            {
                /// {|CSENSE026:<inheritdoc cref="TargetClass.Target"/>|}
                public void M() { }
            }
            """;
        await VerifyCSenseAsync(testCode, diagnosticOptions: [("CSENSE001", ReportDiagnostic.Suppress), ("CSENSE002", ReportDiagnostic.Suppress)]);
    }
}
